...
module.exports.POST_addStoreAssociate = async (req, res) => {
  try {
    const schemaCheckEmailId = Joi.object().keys({
      vendorEmailId: Joi.string().required(),
      storeAssociateEmailId: Joi.string().required(),
      name: Joi.string().required(),
      whatsappNumber: Joi.string().optional().allow("")
    });
    let params = await validateSchema(req.body, schemaCheckEmailId);
    const adminBao = new AdminBao();
    const result = await adminBao.addStoreAssociate(
      params.vendorEmailId.toLowerCase(),
      params.storeAssociateEmailId.toLowerCase(),
      params.name,
      params.whatsappNumber
    );
    return _200(res, result);
...
module.exports.POST_updateBrandUser = async (req, res) => {
  try {
    // logger.info("inside POST_addBrandUser");
    const schemaUpdateBrandUser = Joi.object().keys({
      adminUserId: Joi.string().required(),
      brandEmail: Joi.string().required(),
      whatsappNumber: Joi.string().optional().allow("")
    });
    let params = await validateSchema(req.body, schemaUpdateBrandUser);
    const adminBao = new AdminBao();
    const result = await adminBao.updateBrandUser(
      params.adminUserId,
      params.brandEmail,
      params.whatsappNumber
    );
...
module.exports.GET_allStylist = async (req, res) => {
  try {
    const schemaCheckEmailId = Joi.object().keys({
      adminUserId: Joi.string().required(),
      page: Joi.number().optional(),
    ...
    let params = await validateSchema(req.query, schemaCheckEmailId);
    const adminBao = new AdminBao();
    const result = await adminBao.getAllStylist(
      params.adminUserId,
      page,
      limit
    );
...
module.exports.GET_allStoreAssociates = async (req, res) => {
  try {
    ...
    const adminBao = new AdminBao();
    const result = await adminBao.getAllStoreAssociates(
      params.vendorId,
      page,
      limit
    );
...
module.exports.GET_stylistDetails = async (req, res) => {
  try {
    const schemaVerifyData = Joi.object().keys({
      adminUserId: Joi.string().required(),
    ...
    let params = await validateSchema(req.query, schemaVerifyData);
    const adminBao = new AdminBao();
    const result = await adminBao.getStylistDetails(
      params.adminUserId,
      params.personalStylistId
    );
    return _200(res, result);
  } catch (e) {
    throw _sendGenericError(res, e);
...
module.exports.POST_deleteStoreAssociates = async (req, res) => {
  try {
    // logger.info("inside POST_deleteBrands");
    const schemaVerifyData = Joi.object().keys({
      vendorId: Joi.string().required(),
      storeAssociateIds: Joi.array().items(Joi.string().required()),
    });
    let params = await validateSchema(req.body, schemaVerifyData);
    const adminBao = new AdminBao();
    const result = await adminBao.deleteStoreAssociateAccounts(
      params.vendorId,
      params.storeAssociateIds
    );
    // logger.info("result", result);
    return _200(res, result);
  } catch (e) {
...
module.exports.POST_addProduct = async (req, res) => {
  try {
    ...
    const schemaVerifyData = Joi.object().keys({
      ...
      staticBrandId: Joi.number().optional(),
...
module.exports.GET_getAllProducts = async (req, res) => {
  try {
    ...
    let params = await validateSchema(req.query, schemaVerifyData);
    const adminBao = new AdminBao();
    const result = await adminBao.getAllProducts(params.adminUserId, params.page, params.limit);
    // logger.info("success");
    return _200(res, result);
  } catch (e) {
    throw _sendGenericError(res, e);
...
module.exports.GET_popularBrands = async (req, res) => {
  try {
    // logger.info("inside GET_popularBrands");
    const schemaVerifyData = Joi.object().keys({
      page: Joi.number().optional(),
      limit: Joi.number().optional(),
    });
    ...
    let params = await validateSchema(req.query, schemaVerifyData);
    const adminBao = new AdminBao();
    const result = await adminBao.getPopularBrands();
    // logger.info("success");
    return _200(res, result);
  } catch (e) {
    throw _sendGenericError(res, e);
...
module.exports.GET_referralDetails = async (req, res) => {
  try {
    // logger.info("inside GET_referralDetails");
    const schemaVerifyData = Joi.object().keys({
    ...
    let params = await validateSchema(req.query, schemaVerifyData);
    const adminBao = new AdminBao();
    const result = await adminBao.getReferralDetails(params);
    // logger.info("success");
    return _200(res, result);
  } catch (e) {
    throw _sendGenericError(res, e);
...
module.exports.POST_addVideo = async (req, res) => {
  try {
    // logger.info("inside POST_addProduct");
    const schemaAddVideo = Joi.object().keys({
      adminUserId: Joi.string().required(),
      videoLink: Joi.string().required(),
      name: Joi.string().required()
    });
    let params = await validateSchema(req.body, schemaAddVideo);
    const adminBao = new AdminBao();
    const result = await adminBao.addVideoData(params);
    // logger.info("result", result);
    return _200(res, result);
  } catch (e) {
    console.log(e)
...
module.exports.GET_getAllVideos = async (req, res) => {
  try {
    // logger.info("inside POST_addProduct");
    const schemaGetAllVideo = Joi.object().keys({
      adminUserId: Joi.string().required(),
      page: Joi.string().optional(),
      limit: Joi.string().optional()
    });
    let params = await validateSchema(req.query, schemaGetAllVideo);
    const adminBao = new AdminBao();
    const result = await adminBao.getAllVideoData(params);
    // logger.info("result", result);
    return _200(res, result);
  } catch (e) {
    console.log(e)
...
module.exports.POST_removeVideo = async (req, res) => {
  try {
    // logger.info("inside POST_addProduct");
    const schemaRemoveVideo = Joi.object().keys({
      adminUserId: Joi.string().required(),
      videoId: Joi.string().required()
    });
    let params = await validateSchema(req.body, schemaRemoveVideo);
    const adminBao = new AdminBao();
    const result = await adminBao.removeVideoData(params);
    // logger.info("result", result);
    return _200(res, result);
  } catch (e) {
    console.log(e)
